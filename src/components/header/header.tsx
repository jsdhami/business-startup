        ...
        <div className="flex h-16 items-center justify-between">
          ...
          {session?.user ? (
              <div className="hidden sm:flex">
                ...
                <div className="hidden sm:flex">
                  <Image src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="user" width={40} height={40} className='rounded-full' />
                </div>
              )}
            <div className="sm:flex sm:gap-4">
              {!session ?
                (
                  <button className="rounded-md bg-blue-600 px-5 py-2.5 text-sm font-medium text-white shadow">
